...
publishDate: 2016-08-01 12:00:00
description: |
  A wealth of information exists in well construction reports (WCRs), some of which is valuable when you are looking for evidence of karst geology. The Wisconsin Geology and Natural History Survey (WGNHS) stores digital archives of all WCRs for wells...
---

A wealth of information exists in well construction reports (WCRs), some of which is valuable when you are looking for evidence of [karst geology](https://en.wikipedia.org/wiki/Karst). The Wisconsin Geology and Natural History Survey (WGNHS) stores digital archives of all WCRs for wells created before 1989. These come in the form of PDFs, which, though generally legible and full of information, are hard to use for any large scale analysis.

![](/assets/notes/CR1.jpg)

The [Crawford Stewardship Project](https://crawfordstewardship.org) in Southwestern Wisconsin wanted to mine the data from WCRs to support their efforts to protect water quality in a geologically fragile region of that state.
...
![](/assets/notes/wcr-full-chart.png)